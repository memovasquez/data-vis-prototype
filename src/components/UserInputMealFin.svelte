...
<main>
    ...
    <div class="form-container">
        ...
        <label for="missedMeal" class="form-element">Have you missed a meal in the past week?</label>
        <select id="dropdown" on:change={handleSelectMeal} class="form-element">
          <option value={false}>No</option>
          <option value={true}>Yes</option>
        </select>

        <label for="borrowedMoney" class="form-element">Have you borrowed money for food in the past week?</label>
        <select id="dropdown" on:change={handleSelectMoney} class="form-element">
          <option value={false}>No</option>
          <option value={true}>Yes</option>
        </select>

        <label for="hasDebt" class="form-element">Do you have any revolving debt?</label>
        ...
        {#if hasDebt}
        <label for="debtAmount" class="form-element">Amount of Debt</label>
